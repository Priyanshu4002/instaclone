...
import usePreviousImg from "../../hooks/usePreviousImg";
...
const CreatePost = () => {
    ...
    const {selectedFile,setSelectedFile,handleImageChange}= usePreviousImg();
						...
						/>
                        {
                            selectedFile && (
                                <Flex mt={5} width={'full'} position={"relative"} justifyContent={'center'}>
                                    <Image src={selectedFile} alt="seleceted img" />
...
function useCreatePost(){
    ...
    const handleCreatePost = async (selectedFile,caption)=>{
        ...
        try {
            ...
            showToast('Success',"Post created succeessfully",'success');

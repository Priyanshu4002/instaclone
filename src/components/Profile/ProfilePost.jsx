    ...
    >
        ...
        <ModalContent>
          ...
          <ModalBody bg={'black'} pb={5}>
            <Flex maxH={'90vh'} maxW={'65vw'} gap={'4'} w={{base:'90%',sm:'70%',md:'full'}} mx={'auto'}>
              <Flex 
                borderRadius={4}
                overflow={'hidden'}
                border={'1px solid'}
                ...
                <Flex alignItems={'center'} justifyContent={'space-between'}>
                  ...
                  </Flex>
                 {
                  authUser?.uid === userProfile.uid && (
                    <Button size={'sm'} background={'transparent'} _hover={{color:'red.600',bg:"whiteAlpha.300"}}
                            onClick={handleDeletePost} isLoading={isDeleting} borderRadius={4} p={1}>
